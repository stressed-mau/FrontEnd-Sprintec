...
export default function AboutPage() {
  return (
    <div className="flex min-h-screen flex-col bg-linear-to-b from-[#F2EBDF] via-[#ECF4F9] to-[#4982AD]">
      <Header />
      <main id="principal-sobre-nosotros" className="flex-1 px-4 py-12 sm:px-6 sm:py-16">
        <div className="mx-auto max-w-6xl space-y-8">
          <section id="seccion-presentacion-sobre-nosotros" aria-labelledby="titulo-sobre-nosotros" className="space-y-4 text-center">
            <p className="text-sm font-semibold uppercase tracking-[0.28em] text-[#4982AD]">Sobre la plataforma</p>
            <h1 id="titulo-sobre-nosotros" className="text-4xl font-bold tracking-tight text-[#003A6C] sm:text-5xl">
          ...
          <Card id="tarjeta-resumen-sobre-nosotros" className="border-[#C2DBED] bg-white/85 shadow-xl backdrop-blur-sm">
            <CardHeader className="space-y-3 border-b border-[#D7E6F2]">
              <CardTitle id="titulo-resumen-sobre-nosotros" className="text-2xl font-bold text-[#003A6C] sm:text-3xl">
                ¿Qué es PortfolioGen?
              </CardTitle>
          ...
          <section id="seccion-tarjetas-sobre-nosotros" aria-labelledby="titulo-resumen-sobre-nosotros" className="grid gap-5 md:grid-cols-2">
