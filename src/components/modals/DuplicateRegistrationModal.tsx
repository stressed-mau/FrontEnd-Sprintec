  ...
  return (
    ...
    >
      <div className="flex flex-col items-center text-center">
        ...
        <h3 className="mb-2 max-w-full break-words text-xl font-bold leading-tight text-[#003A6C] sm:text-2xl">{title}</h3>
        <p className="mb-6 max-w-full break-words text-base leading-6 text-[#6B7280] sm:mb-8 sm:text-lg">{message}</p>
        <button
          type="button"
          onClick={onClose}
